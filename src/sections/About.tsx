...
import yabets_img from "../assets/imgs/yabets.jpg";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <p className="text-[#ade8f4] mb-6 leading-relaxed">
              ...
              actively exploring systems programming, backend development, and
              web3 development with Rust. I’m also a 6th-generation graduate of
              A2SV, an organization dedicated to training top-tier engineers in
            ...
            <div className="bg-[#023e8a] p-6 rounded-lg shadow-md border-l-4 border-[#48cae4] mb-6">
              ...
              <p className="text-[#90e0ef] text-right mt-2">― C.S. Lewis</p>
            </div>
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-[#023e8a] p-4 rounded-lg shadow-lg">
                <div className="text-[#caf0f8] font-bold">2+ Years</div>
                <div className="text-[#90e0ef] text-sm">Coding Experience</div>
              </div>
            </div>
          </div>
        </div>
